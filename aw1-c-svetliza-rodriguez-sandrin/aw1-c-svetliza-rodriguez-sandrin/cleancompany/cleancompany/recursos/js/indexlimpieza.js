import { renderizarProductos, renderizarProductosCarro } from "./funcionesproductos.js";
...
const botonAbrirPopup = document.getElementById('abrir-popup-carro-productos')

botonAbrirPopup.addEventListener("click", () => {
    const popupCarro = document.getElementById("popup-carro-productos")
    if(popupCarro.open){
        popupCarro.close()
    }else{
...
botonesProductos.forEach(boton => {
    ...
    boton.addEventListener('click',()=>{
        ...
        const contadorItems = document.getElementById('carro-items-productos')
