...
fetch('./recursos/json/productos.json')
    ...
    .then(datos => {
        renderizado(datos, "productoLimpieza", contenedor);
        asignarEventoBotones(datos.productos);
    });

// Manejo del popup del carrito
const botonAbrirPopup = document.getElementById('abrir-popup-carro-producto');
botonAbrirPopup.addEventListener("click", () => {
    const popupCarro = document.getElementById("popup-carro-producto");
