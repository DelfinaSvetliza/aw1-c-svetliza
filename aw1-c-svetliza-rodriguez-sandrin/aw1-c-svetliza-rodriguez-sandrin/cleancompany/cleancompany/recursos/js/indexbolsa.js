import { renderizarProductos, renderizarProductosCarro } from "./funcionesbolsa.js";
// import { helados } from "./helados.js";

// Referenciamos
const contenedor = document.getElementById('contenedor-bolsa')

// Invocamos la función
renderizarProductos(contenedor)

// Referenciamos el elemento boton abrir popup
const botonAbrirPopup = document.getElementById('abrir-popup-carro-bolsa')

botonAbrirPopup.addEventListener("click", () => {
    const popupCarro = document.getElementById("popup-carro-bolsa")
    if(popupCarro.open){
        popupCarro.close()
    }else{
...
botonesProductos.forEach(boton => {
    ...
    boton.addEventListener('click',()=>{
        ...
        const contadorItems = document.getElementById('carro-items-bolsa')
