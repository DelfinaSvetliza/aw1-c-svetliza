import { renderizarProductos, renderizarProductosCarro } from "./funcionescuidado.js";
// import { helados } from "./helados.js";

// Referenciamos
const contenedor = document.getElementById('contenedor-cuidado')

// Invocamos la función
renderizarProductos(contenedor)

// Referenciamos el elemento boton abrir popup
const botonAbrirPopup = document.getElementById('abrir-popup-carro-cuidado')

botonAbrirPopup.addEventListener("click", () => {
    const popupCarro = document.getElementById("popup-carro-cuidado")
    if(popupCarro.open){
        popupCarro.close()
    }else{
...
botonesProductos.forEach(boton => {
    ...
    boton.addEventListener('click',()=>{
        ...
        const contadorItems = document.getElementById('carro-items-cuidado')
